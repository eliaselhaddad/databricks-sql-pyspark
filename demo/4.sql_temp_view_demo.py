...
# one can create a variable like so, and change the year as needed to make it more dynamic
# this feature is only available when using Python, not SQL
p_race_year = 2019
...
# MAGIC %sql
# MAGIC -- creating a global view allows you to access the view from another notebook 
# MAGIC SELECT *
